      ...
      >
        ...
        <div className="ps-container relative pt-40 pb-24 sm:pt-48 sm:pb-28 lg:pt-52 lg:pb-32">
          ...
          >
            ...
            <span style={{ color: "var(--theme-text-muted)" }}>{product.category}</span>
            <span aria-hidden="true">/</span>
            <span style={{ color: "var(--theme-text-primary)" }}>{product.name}</span>
          </nav>
          ...
          <div className="ps-container">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
              {relatedProducts.slice(0, 3).map((related, i) => (
                <ProductCard key={related.slug} product={related} accentIndex={i} />
              ))}
            </div>
          </div>
        </section>
