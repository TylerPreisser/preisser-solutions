      ...
      <div className="ps-hero-content">
        ...
        */}
        <p className="ps-hero-summary">
          Preisser Solutions helps Hays and Northwest Kansas businesses get found on
          Google, convert more website visitors, and follow up with leads
          automatically through websites, local SEO, Google Business Profile
          optimization, Google Ads, review systems, and AI automation.
        </p>
        ...
        <div ref={ctasRef} className="ps-hero-ctas">
          ...
          <a href="tel:+16203523296" className="ps-btn ps-btn-secondary">
