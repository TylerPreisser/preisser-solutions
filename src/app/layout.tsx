...
export const metadata: Metadata = {
  title: {
    default: "Preisser Technology",
    template: "%s | Preisser Technology",
  },
...
// construct a complete knowledge graph for Preisser Technology.
//
// Entity IDs:
...
const structuredData = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    description:
      "You show us the problem. We see the solution. Preisser Technology designs and builds custom websites, applications, AI, automations, and visualizations from the ground up for businesses across Kansas and the Great Plains. Based in Hays, Kansas. Founded by Tyler Preisser.",
    ...
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Preisser Technology Service Catalog",
      itemListElement: [
        {
          "@type": "Offer",
          itemOffered: {
  ...
  // -------------------------------------------------------------------------
  {
    ...
    "@id": WEBPAGE_ID,
    url: "https://preissertech.com",
    name: "Preisser Technology | We Build Websites, Apps & Automations for Kansas Businesses",
    description:
      "You show us the problem. We see the solution. Preisser Technology designs and builds custom websites, applications, AI, automations, and visualizations from the ground up for your business. 22+ projects delivered from Hays, Kansas by Tyler Preisser.",
  ...
  // -------------------------------------------------------------------------
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Custom website pricing at Preisser Technology depends on scope and complexity. A professional marketing site for a Kansas small business typically starts in the low thousands and scales based on the number of pages, custom features, and integrations required. Unlike agencies that charge for project managers and overhead, Preisser Technology keeps costs efficient because you work directly with Tyler — the person doing the actual work. Contact us at sales@preissertech.com for a free project estimate tailored to your specific needs.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Timeline for a custom web application at Preisser Technology varies based on complexity. A focused internal tool or client portal can often be delivered in four to eight weeks. More complex applications with custom databases, third-party integrations, and multi-role user systems typically run eight to sixteen weeks. Because Tyler Preisser handles development directly without layers of project handoffs, Preisser Technology moves significantly faster than traditional agencies for comparable quality and scope.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Off-the-shelf software is a great starting point for generic needs. The signal that you need custom software is when you find yourself working around the tool — using spreadsheets to compensate for what it cannot do, paying for features you do not need, or watching your team waste time on manual steps the tool should handle automatically. Preisser Technology offers free consultations to help Kansas business owners evaluate whether a custom build is actually the right investment, or whether a better-configured existing tool solves the problem at lower cost.",
        },
      },
      {
        "@type": "Question",
