...
import { pageData } from "@/data/aeo/services/google-business-profile-optimization-hays-ks";
...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: pageData.metaTitle, description: pageData.metaDescription, images: ["/images/og-image-v2.jpg"] },
};
