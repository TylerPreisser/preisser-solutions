...
export const product: ProductData = {
  ...
  whatItDoes: [
    "MarCommand is the proprietary multi-agent marketing engine behind Preisser Solutions' marketing service offering. The complexity stays inside the engine; what reaches the client is the work itself, plus one dashboard showing what each channel spent, what came back, and what a customer actually cost to win.",
