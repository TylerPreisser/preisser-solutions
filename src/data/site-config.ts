export const siteConfig = {
  ...
  // `valueStrip` (10 capability pills) and `proofBar` (9 proof claims) were
  // deleted here on 2026-09-04. Both existed only to feed marquees, then
  // <Capabilities>, and that section is gone (ADR-0007). Nothing was silently
  // dropped -- each entry was diffed against the rest of the homepage first:
  //   - "22+ Kansas SMB projects delivered" was UNIQUE and was relocated into
  //     the .ps-services-intro paragraph in service-pillars.tsx.
  //   - "Client & member portals" was relocated into the serviceTile title
  //     "Client & Member Portals, Booking & Intake" (service-pillars.tsx).
  //   - "Founder-led..." survives in lib/seo/site.ts, hero.tsx and
  //     service-pillars.tsx's intro paragraph.
  //   - The 4 operational metrics survive in service-pillars.tsx serviceTiles
  //     and differentiators, and in case-studies.tsx.
  //   - The 3 FarmBooks / Iron and Oak claims survive ONLY in case-studies.tsx.
  //     That file is now load-bearing for them; shortening those two cards
  //     removes those outcomes from the homepage and no gate would catch it.
  // Do not re-add either key without checking those homes first.
} as const;
