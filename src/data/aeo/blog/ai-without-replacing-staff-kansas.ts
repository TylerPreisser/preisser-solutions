...
export const pageData: AeoPageData = {
  slug: "blog/ai-without-replacing-staff-kansas",
  tier: "blog",
  datePublished: "2026-04-10",
  dateModified: "2026-05-15",
  metaTitle: "How To Use AI Without Replacing Staff (Kansas Edition)",
  metaDescription:
  ...
  h1: "How To Use AI Without Replacing Your Staff (Kansas Edition)",
  subheadline:
  ...
  sections: [
    ...
    {
      eyebrow: "Where to apply AI",
      heading: "The high-volume, low-judgment work",
      body: [
    ...
    {
      eyebrow: "Where NOT to apply AI",
      heading: "The work that actually requires a human",
      body: [
  ...
  faq: [
    {
      question: "Won't I save more money by replacing someone?",
      answer:
