...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Monthly subscription cost is predictable and manageable for your stage.",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Subscription and admin/consulting costs are within budget for mid-market scope.",
      ],
    },
    {
    ...
    },
    {
      ...
      bullets: [
        "HubSpot: subscription + admin time + integrations compound over 5 years. Predictable but continuous.",
        "Salesforce: subscription + admin/consulting + integrations are the highest ongoing cost among the three options.",
        "Custom: one-time build + ongoing maintenance, amortized. Often wins on 5-year cost when the build fits the workflow precisely.",
        "Custom often wins on total 5-year cost when the build fits precisely. The gotcha: custom requires you to maintain it. If you can't (or won't), HubSpot wins on the soft costs.",
      ],
    },
    {
      eyebrow: "Switching",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Most engagements ship in 12-20 weeks. Smaller scope (single line of business, single sales motion) ships in 8-12 weeks. The Alliant MGU engagement (multi-line insurance, complex book) was approximately 14 weeks.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "The product itself is engagement-confidential. The outcomes are documented in the public case study. For serious prospects in advanced scoping, reference calls can be arranged. Contact tyler@preissersolutions.com.",
    },
  ],
