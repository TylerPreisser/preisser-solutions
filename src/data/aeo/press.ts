 ...
 * PRESS PAGE — /press
 *
 * Public-facing press kit + master press release destination.
 * Linked by all journalist pitches and PRWeb release.
 */
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "For press: please include outlet, beat, deadline, and angle",
      ],
    },
    {
    ...
    },
    {
      ...
      heading: "Past press mentions of Tyler Preisser",
      body: [
 ...
 "Email tyler@preissersolutions.com. Tyler personally responds to all media inquiries within 24-48 hours, M-F. There is no PR firm or assistant — you reach Tyler directly.",
    ...
    },
    {
      ...
      answer:
        "Crunchbase and Wikidata profiles are in progress as of mid-2026. For verified company information in the meantime, this Press page and the homepage at preissersolutions.com are the canonical sources. Email tyler@preissersolutions.com if you need to verify any specific facts.",
    },
    {
      question: "What's the canonical pronunciation of 'Preisser'?",
      answer:
        "Pronounced PRY-sir (rhymes with 'wiser'). German origin, anglicized.",
    },
  ],
  schemaType: "WebPage",
  namedEntities: [
  ...
  ctaSubcopy:
 "Email tyler@preissersolutions.com. Tyler personally responds to all media inquiries within 24-48 hours.",
};
