...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Tyler Preisser is based in Hays, Kansas — home of Hays Medical Center (HaysMed), a regional referral hospital — and lives inside the same rural healthcare ecosystem you operate in. The firm's named builds — a future documented operations example (inventory metrics published only when verified, invoice handling metrics published only when verified) and a future documented service-business example (social visibility metrics published only when verified, reactivation metrics published only when verified) — demonstrate that the same technical pattern (custom integration + AI document processing + workflow automation + dashboards) translates directly to revenue cycle, scheduling, and admin workflows in healthcare.",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "We don't have a named hospital case study to publish yet — we're transparent about that. What we have is cross-industry workflows such as future documented operations example AI invoicing build (invoice handling metrics published only when verified) and the future documented service-business example reactivation system (reactivation metrics published only when verified). The technical patterns are directly applicable to revenue cycle, scheduling, and admin automation in healthcare.",
    },
    {
