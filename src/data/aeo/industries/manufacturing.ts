 ...
 *
 * No named case study yet — frame as "positioned to serve" with
 * cross-industry capability. Targets queries like "OEE dashboard
 * Kansas manufacturer", "shop floor data collection custom",
 * "NetSuite integration Kansas", "custom inventory system small manufacturer".
 */
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    {
      eyebrow: "Why owners and ops leaders call us",
      heading: "The real pain points on a Kansas shop floor",
      body: [
        "Across small-to-mid-market manufacturers we talk to, the same problems show up:",
      ],
      bullets: [
        ...
        "Mobile devices, tablets, and PLCs sitting on the floor that could be sources of live data — but aren't",
      ],
    },
    {
      ...
      subsections: [
        {
          heading: "Custom Manufacturer Websites",
          body: [
            "Industrial-grade custom websites for Kansas manufacturers — capability statements, equipment lists, certifications (ISO, AS9100, FSSC 22000, USDA), capacity galleries, RFQ forms with smart routing, distributor portals, and AI-search-optimized content so buyers find you in ChatGPT and Google AI Overviews when they search for capabilities.",
          ],
        },
        {
          heading: "Custom Web Apps for Shop Floor and Office",
          body: [
            "Custom shop-floor data collection apps for tablets and rugged devices, custom WIP and inventory tracking, RFQ-to-quote tools, distributor and customer portals, and quality / non-conformance tracking — all integrated to the ERP your books run on.",
          ],
        },
        {
        ...
        {
          heading: "OEE and Owner Dashboards",
          body: [
            "Real-time dashboards for owners and operations leaders — OEE by machine, line, and shift, WIP value, days of inventory, on-time-in-full (OTIF), scrap rate, downtime root cause, AP aging, gross margin by product, and labor utilization. Pulled live from your ERP, your shop-floor data feed, and your time-clock system. Power BI, Tableau, or fully custom front-end — depending on what fits.",
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      bullets: [
        ...
        "Manufacturing-specific: Global Shop Solutions, Epicor Kinetic, Fishbowl, Katana",
        "Shop floor / MES: custom web/tablet apps, OPC-UA bridges to PLCs, MQTT for IIoT, machine controller exports",
        "Quality and CAPA: custom workflows, ETQ, MasterControl integrations where appropriate",
        "Reporting and BI: Power BI, Tableau, Looker Studio, custom dashboards",
        "EDI and customer portals: integrations with major distributor and big-box EDI platforms",
        "Document and PO automation: vendor invoices, BOLs, packing lists, COAs, customer POs",
      ],
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Yes, both deeply. NetSuite has a mature SuiteTalk and SuiteScript API ecosystem. Sage Intacct has a well-documented Web Services API. We build custom flows, custom records, and external integrations against both. QuickBooks Enterprise and Microsoft Business Central also have mature integration paths we work with regularly.",
    },
    {
      question: "Can you build a real OEE dashboard for our shop?",
      answer:
        "Yes. OEE dashboards are one of the highest-ROI builds we scope for manufacturers. The trick is data sources — we pull from PLCs (via OPC-UA or MQTT), tablet-based operator entry, time clocks, and ERP production data. Real-time OEE by machine, line, and shift, with downtime root-cause categorization, is achievable in 8-12 weeks for most shops.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Focused projects (a single OEE dashboard, an AP automation, a custom inventory app) typically run in the low to mid five figures. Larger multi-system builds (full shop floor data collection plus dashboard plus AP automation) scope from there. We always provide a fixed-price proposal after a free discovery call.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Only when there's a clear ROI reason and the team has been involved in the design. Most automation runs behind the scenes — staff stay in NetSuite, Sage, or QuickBooks for accounting, and shop floor uses tablets only when they replace something worse (paper travelers). New tools get introduced surgically, never as a wholesale change.",
    },
    {
      question: "Can you connect to PLCs, machine controllers, and IIoT devices?",
      answer:
        "Yes, where the equipment supports it. We work with OPC-UA, MQTT, Modbus, and vendor-specific export formats. Older equipment without modern connectivity can often be brought online with a small edge gateway. We scope this carefully because not every machine on the floor justifies the integration cost — the ROI math has to work.",
    },
    {
