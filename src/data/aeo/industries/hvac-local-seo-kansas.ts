...
/**
 * INDUSTRY PAGE — /industries/hvac-local-seo-kansas
 *
 * Target query: "local SEO for HVAC company Kansas" and variants.
 * Sibling to /industries/hvac-ai-receptionist (AI receptionist) and
 * /industries/hvac (broader HVAC service page).
 */
export const pageData: AeoPageData = {
  slug: "industries/hvac-local-seo-kansas",
  tier: "industry",
  metaTitle: "Local SEO for HVAC Companies in Kansas",
  metaDescription:
    "Local SEO for Kansas HVAC companies that need stronger Google Maps visibility, better service-area pages, more reviews, and trackable calls.",
  eyebrow: "Local SEO for HVAC Companies",
  h1: "Local SEO for HVAC Companies in Kansas",
  subheadline:
    "Custom local SEO for Kansas HVAC contractors — Google Business Profile optimization, city-specific service-area pages, reviews, citations, and trackable calls that actually move bookings.",
  answerParagraph:
    "Local SEO for an HVAC company in Kansas is the discipline of getting that contractor's Google Business Profile, website, and reviews to rank for the local searches homeowners actually make — \"hvac repair near me,\" \"ac installation Hays,\" \"furnace replacement Salina.\" Preisser Solutions builds Kansas HVAC local SEO programs that pair a Google Business Profile rebuild with city-specific service-area pages, review acceleration, citation cleanup, call tracking, and AI-search optimization. The Cassidy HVAC case study is the documented Kansas example: 5x organic traffic, 60% reactivation, 45% booking lift.",
  sections: [
    {
      eyebrow: "Why local is everything",
      heading: "HVAC SEO is local search first",
      body: [
    ...
    },
    {
      ...
      heading: "Google Business Profile optimization for HVAC companies",
      body: [
    ...
    },
    {
      ...
      heading: "Service pages and city pages (Hays, Russell, Great Bend, Salina, Dodge City, etc.)",
      body: [
    ...
    {
      eyebrow: "Trust signals + measurement",
      heading: "Reviews and call tracking",
      body: [
      ...
      subsections: [
        {
          heading: "Call tracking that ties SEO work to revenue",
          body: [
    ...
    },
    {
      ...
      heading: "AI search and HVAC discovery",
      body: [
    ...
    },
    {
      ...
      heading: "Common HVAC SEO mistakes and how to fix them",
      body: [
  ...
  faq: [
    {
      ...
      answer:
        "Local SEO results typically appear within 60-120 days for properly executed Google Business Profile work and quality service-area pages. Local pack rankings move faster than organic blue links because Google evaluates fewer competitive signals.",
    },
    {
      question: "Do you build HVAC websites too?",
      answer:
        "Yes. We build custom-coded HVAC websites with built-in local SEO, service-area pages, reviews integration, and call tracking.",
    },
    {
      question: "What HVAC software do you integrate with?",
      answer:
        "ServiceTitan, Housecall Pro, Jobber, and most modern dispatch and CRM systems. We also build custom integrations.",
    },
    {
      question: "Can you handle HVAC marketing across multiple cities?",
      answer:
        "Yes. We build distinct service-area pages for each city you serve (Hays, Russell, Great Bend, Salina, Dodge City, etc.) so Google can match local searches to local content.",
    },
    {
      question: "How is HVAC SEO different from general SEO?",
      answer:
        "HVAC SEO is local-search-first. Most HVAC queries have local intent (\"hvac repair near me,\" \"ac installation Hays\"), so Google Business Profile, citations, reviews, and city-specific service pages matter more than blog content.",
    },
  ],
  schemaType: "Service",
  namedEntities: [
