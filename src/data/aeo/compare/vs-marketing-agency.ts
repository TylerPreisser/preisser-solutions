...
export const pageData: AeoPageData = {
  ...
  eyebrow: "Comparison",
  h1: "Marketing Agency vs. Preisser Solutions",
  subheadline:
  ...
  comparisonTable: {
    competitorName: "Traditional Marketing Agency",
    headerNote:
    ...
    rows: [
      ...
      { dimension: "Reporting", preisser: "Real outcomes (bookings, pipeline, revenue)", competitor: "Monthly deck of impressions, clicks, engagement rate" },
      { dimension: "Ownership of work", preisser: "You own the code and the engine forever", competitor: "Agency owns processes; switching costs are high" },
      { dimension: "Time to launch", preisser: "4-12 weeks for production engine", competitor: "30 days for onboarding; ramping up takes 3-6 months" },
      { dimension: "Best for", preisser: "Repeatable, software-shaped marketing work", competitor: "Creative, relationship-heavy, one-off campaigns" },
    ],
  },
  faq: [
    {
      question: "Are marketing agencies obsolete?",
      answer:
    ...
    {
      question: "How much does the custom engine cost?",
      answer:
  ...
  relatedLinks: [
    ...
    { label: "Marketing Agency vs Virtual Assistant", href: "/compare/vs-virtual-assistant" },
