...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Engineered for AI search citation (ChatGPT, Perplexity, Gemini, Claude)",
      ],
    },
    {
  ...
  comparisonTable: {
    ...
    rows: [
      ...
      { dimension: "AI / AEO focus", preisser: "Builds AI agents and engineers websites for crawlable content, schema, and entity clarity", competitor: "Web design and digital marketing focus" },
      { dimension: "Case study evidence", preisser: "Proof standard: a future documented service-business example (social visibility metrics published only when verified, reactivation metrics published only when verified), a future documented operations example (inventory metrics published only when verified)", competitor: "Standard agency portfolio of website builds" },
      { dimension: "Best fit", preisser: "Businesses needing custom code, AI integration, or business automation that doesn't exist off the shelf", competitor: "Kansas small-to-mid-market businesses needing standard agency services" },
      { dimension: "Pricing approach", preisser: "Fixed-price proposals after free scoping calls", competitor: "Standard agency pricing model" },
