...
export const pageData: AeoPageData = {
  ...
  comparisonTable: {
    ...
    rows: [
      ...
      { dimension: "Case study evidence", preisser: "Named client outcomes: Cassidy HVAC (5x reach, 60%+ reactivation), HG Oil Holdings (95% logistics-time reduction)", competitor: "Standard agency portfolio of website builds" },
