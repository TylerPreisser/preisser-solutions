...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    {
      eyebrow: "Local SEO strengths",
      heading: "What local SEO does well",
      body: [
    ...
    {
      eyebrow: "Paid ads strengths",
      heading: "What paid ads do well",
      body: [
    ...
    },
    {
      ...
      heading: "Most Kansas SMBs benefit from a paired investment",
      body: [
  ...
  faq: [
    ...
    {
      question: "What's a realistic local SEO budget?",
      answer:
