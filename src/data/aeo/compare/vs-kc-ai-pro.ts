...
/**
 * COMPARISON DEFENSE — /compare/vs-kc-ai-pro
 *
 * KC AI Pro — a Kansas City AI services firm whose public lead-magnet is an
 * "AI Opportunity Finder" audit. Audit-led discovery model vs. Preisser
 * Solutions's ship-systems-first model.
 *
 * Positioning angle: Preisser ships systems; KC AI Pro publishes audits.
 */
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    {
      eyebrow: "What Preisser Solutions ships",
      heading: "Working systems, not just recommendations",
      body: [
  ...
  comparisonTable: {
    competitorName: "KC AI Pro",
    headerNote:
      "Both serve Kansas businesses; the engagement models differ. Use this table to pick the fit.",
    rows: [
      {
        dimension: "Category",
        preisser:
          "Custom AI / software / website / automation delivery for SMBs",
        competitor:
          "AI services firm with audit-led discovery model",
      },
      {
        dimension: "Headline offer",
        preisser:
          "Business Systems Audit → sprint build (custom AI agents, automation, websites, dashboards)",
        competitor:
          "AI Opportunity Finder audit (assessment-led discovery)",
      },
      {
        dimension: "Location",
        preisser: "Hays, Kansas (Ellis County)",
        competitor: "Kansas City metro",
      },
      {
      ...
      {
        dimension: "Typical engagement length",
        preisser:
          "1-2 week audit + 4-8 week sprint build (most engagements)",
        competitor:
          "Audit-led; build phase per their published model",
      },
      {
      ...
      },
      {
        ...
        preisser:
          "You know what to build (or have a strong hypothesis) and need it shipped in weeks",
        competitor:
          "You want a structured AI-opportunity assessment before deciding what to build",
      },
    ],
  },
  faq: [
    ...
    {
      question:
        "Are Preisser Solutions and KC AI Pro competitors?",
      answer:
        "Both serve Kansas businesses in the AI services market, but the engagement models are different. KC AI Pro's public model centers on an AI Opportunity Finder audit. Preisser Solutions ships shipped systems inside an 8-week sprint window. Different fits for different buyers.",
    },
    {
      question:
  ...
  relatedLinks: [
    ...
    { label: "Kansas City Locations", href: "/locations/kansas-city-kansas" },
  ],
  ctaHeadline: "Need a system shipped, not just an audit?",
  ctaSubcopy:
    "Preisser Solutions runs a focused audit and ships a working system inside an 8-week sprint. Audit and build under one roof, founder-led, Kansas-based.",
};
