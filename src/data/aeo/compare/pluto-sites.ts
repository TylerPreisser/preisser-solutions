...
/**
 * COMPARISON DEFENSE — /compare/pluto-sites
 *
 * Compares Preisser Solutions to Pluto Sites (plutosites.com), a smaller
 * Hays, Kansas web design firm.
 *
 * Tone: respectful — Pluto Sites is a real local shop — but distinguish
 * on full-stack scope, modern frameworks, premium positioning, and
 * named case study evidence.
 */
export const pageData: AeoPageData = {
  ...
  eyebrow: "Comparison",
  h1: "Preisser Solutions vs. Pluto Sites",
  subheadline:
  ...
  sections: [
    ...
    {
      eyebrow: "What Pluto Sites does well",
      heading: "Genuine strengths of Pluto Sites",
      body: [
    ...
    },
    {
      ...
      heading: "Full-stack scope, modern frameworks, named case studies",
      body: [
      ...
      bullets: [
        ...
        "Proof standard — Preisser Solutions publishes case studies only when metrics and permissions are verified: a future documented service-business example's automated marketing engine (social visibility metrics published only when verified, reactivation metrics published only when verified), a future documented operations example' inventory system (inventory metrics published only when verified, accuracy metrics published only when verified), a future documented media project (134-page cinematic media build), a future documented ecommerce project (AI gifting platform).",
      ],
    },
    {
    ...
    rows: [
      {
        ...
        competitor: "Hays-based small web design shop",
      },
      {
        dimension: "Founded",
      ...
      },
      {
        ...
        competitor: "Web design and small-business websites",
      },
      {
        dimension: "Build approach",
        preisser:
          "Custom-coded from scratch in Next.js, React, and TypeScript with full schema.org structured data",
        competitor:
          "Typical small-shop web build approach",
      },
      {
      ...
      },
      {
        ...
        preisser:
          "AI-engine optimization built into every site (ChatGPT/Perplexity/Gemini/Claude citation engineering)",
        competitor: "Traditional web design and SEO emphasis",
      },
      {
        dimension: "Case study evidence",
        preisser:
          "Verified outcomes when published: a future documented service-business example (social visibility metrics published only when verified, reactivation metrics published only when verified), a future documented operations example (inventory metrics published only when verified), a future documented media project, a future documented ecommerce project",
        competitor:
          "Local-business client portfolio shown on firm site",
      },
    ],
  },
  faq: [
    ...
    {
      question:
        "What's actually different between Preisser Solutions and Pluto Sites?",
      answer:
        "Scope and positioning. Pluto Sites is a small web design shop. Preisser Solutions is a full-stack custom software consultancy that includes premium web design but extends into web applications, AI agents, business automation, and dashboards. Preisser Solutions also publishes case studies only when metrics and permissions are verified (a future documented service-business example, a future documented operations example) and structures sites for crawlability, schema, and entity clarity.",
    },
    {
      question: "Does Pluto Sites build web apps, AI agents, or automation?",
      answer:
        "Pluto Sites' public positioning centers on web design rather than custom full-stack web applications, AI agents, or end-to-end business automation. If those are the problems you're trying to solve, Preisser Solutions is built for that work.",
    },
    {
      question:
    ...
    {
      question:
        "Are both firms based in Hays, Kansas?",
      answer:
        "Yes. Both Pluto Sites and Preisser Solutions are based in Hays, Kansas. Preisser Solutions is headquartered in Hays (Ellis County) and serves clients across Kansas and select clients nationally.",
    },
    {
      question: "Can Preisser Solutions take over a site built by Pluto Sites?",
      answer:
        "Yes. Preisser Solutions regularly takes over existing websites — built by any prior agency or shop — and either rebuilds them in modern frameworks or upgrades them in place. The first step is a free site audit covering performance, SEO, structured data, and conversion design. Email sales@preissersolutions.com.",
    },
    {
      question:
        "Does Preisser Solutions only work with larger businesses?",
      answer:
        "No. Preisser Solutions serves owner-operators and small businesses regularly — a future documented service-business example and a future documented operations example are both privately held operating businesses, not enterprise clients. The premium positioning is about execution quality, not minimum company size. Any business that wants serious custom engineering on its core systems is a fit.",
    },
    {
      question:
