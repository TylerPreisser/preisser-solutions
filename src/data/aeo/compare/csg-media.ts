...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    {
      eyebrow: "What CSG Media does well",
      heading: "Genuine strengths of CSG Media",
      body: [
        "CSG Media is an established Salina firm:",
      ],
      bullets: [
        "Full-service creative agency — design, video, branding, marketing all under one roof",
        "Salina-based — in-person service for central Kansas businesses",
        "Established firm with broader service mix than a single-discipline shop",
        "Traditional digital marketing capabilities",
      ],
    },
    {
  ...
  comparisonTable: {
    ...
    headerNote:
      "Honest, fair comparison. CSG Media is an established Salina firm. Pick the one that matches what you actually need.",
    rows: [
