...
export const pageData: AeoPageData = {
  ...
  comparisonTable: {
    ...
    rows: [
      ...
      { dimension: "Case study evidence", preisser: "Cassidy HVAC (5x reach, 60%+ reactivation), HG Oil Holdings (95% logistics-time reduction)", competitor: "Varies by firm — KC firms have strong portfolios" },
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Yes — that's the firm's core positioning. The technology stack is the same (Next.js, React, TypeScript). The named case studies (Cassidy HVAC, HG Oil Holdings) match what KC boutiques publish. The difference is operating model and pricing, not capability.",
    },
    {
