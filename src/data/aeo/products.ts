...
export const pageData: AeoPageData = {
  ...
  faq: [
    {
      ...
      answer:
        "Currently configurable per the signed proposal. Pricing is not yet published on the site. Contact sales@preissersolutions.com for a fixed-price quote based on call volume, integrations, and escalation complexity.",
    },
    {
  ...
  ctaSubcopy:
    "Email sales@preissersolutions.com to start a scoping call. Productized doesn't mean templated — every engagement is custom-built; the SKU just sets the starting scope.",
};
