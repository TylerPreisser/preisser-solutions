...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Ottawa industries served",
      body: [
        "Ottawa's economy combines education, manufacturing, healthcare, and services.",
      ],
      bullets: [
        "Education — Ottawa University vendors, alumni-owned firms, student-housing operators",
        "Manufacturing — local manufacturers and tier-2 suppliers",
        "Healthcare — Ransom Memorial Health and surrounding clinics",
  ...
  faq: [
    {
      question: "Do you serve Ottawa, Kansas?",
      answer:
        "Yes. Ottawa engagements are handled personally by Tyler Preisser as a remote-with-travel market.",
    },
    {
      question: "How far is Hays from Ottawa?",
      answer:
        "Ottawa is approximately 225 miles east of Hays — about three-and-a-half hours by car.",
    },
    {
      question: "Can you build software for an Ottawa University vendor?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Custom website pricing in Ottawa typically starts in the low thousands and scales with scope. Email tyler@preissertech.com for a free estimate.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Ottawa project personally — free, no commitment.",
};
