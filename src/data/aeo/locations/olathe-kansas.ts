...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Olathe industries served",
      body: [
        "Olathe's economy is unusually diverse — consumer electronics, defense, healthcare, services, education.",
      ],
      bullets: [
        "Consumer electronics and aviation — Garmin International and tier-2 suppliers",
        "Defense and national security — Honeywell FM&T and surrounding contractors",
        "Healthcare — AdventHealth Olathe, Olathe Health, and surrounding clinics",
        "Manufacturing — local manufacturers and tier-2 suppliers",
        "Professional services — law firms, accounting firms, financial advisors, insurance agencies",
        "Real estate and home services — high-income consumer market",
        "Trucking and logistics — I-35 corridor",
      ],
    },
    {
  ...
  faq: [
    {
      question: "Do you serve Olathe, Kansas?",
      answer:
        "Yes. Olathe engagements are handled personally by Tyler Preisser as a remote-with-travel market.",
    },
    {
      question: "How far is Hays from Olathe?",
      answer:
        "Olathe is approximately 270 miles east of Hays — about four hours by car.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes — that's exactly the firm's positioning. Premium custom-coded work in Next.js, React, and TypeScript without KC-metro or coastal-agency overhead. Tyler personally codes every engagement.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Olathe project personally — free, no commitment.",
};
