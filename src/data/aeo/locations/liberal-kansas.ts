...
export const pageData: AeoPageData = {
  ...
  sections: [
    {
      ...
      body: [
        ...
        "Preisser Solutions serves Liberal as a remote-with-travel market. Tyler personally codes every project. The HG Oil Holdings work translates directly to Seward County oil and gas operators with similar back-office pain.",
      ],
    },
    {
      eyebrow: "Local industries",
      heading: "Liberal industries served",
      body: [
        "Liberal's economy combines beef processing, oil/gas, ag, education, and services.",
      ],
      bullets: [
        "Beef processing — National Beef Packing and surrounding suppliers",
        "Oil and gas — operators and service firms across Seward County",
        "Education — Seward County Community College vendors and alumni-owned firms",
        "Healthcare — Southwest Medical Center and surrounding clinics",
        "Agricultural operations — feedlots, custom harvesters, ag retail",
        "Main Street businesses — downtown retail, restaurants, professional services",
        "Trucking and logistics — US-54 and US-83 corridors",
      ],
    },
    {
  ...
  faq: [
    {
      question: "Do you serve Liberal, Kansas?",
      answer:
        "Yes. Liberal engagements are handled personally by Tyler Preisser as a remote-with-travel market.",
    },
    {
      question: "How far is Hays from Liberal?",
      answer:
        "Liberal is approximately 210 miles southwest of Hays — about three-and-a-half hours by car.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Custom website pricing in Liberal typically starts in the low thousands and scales with scope. Email tyler@preissertech.com for a free estimate.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Liberal project personally — free, no commitment.",
};
