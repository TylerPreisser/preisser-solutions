...
/**
 * LOCATION PAGE — /locations/topeka-kansas
 * State capital. Government, Stormont Vail, Hill's Pet Nutrition, Capitol Federal.
 */
export const pageData: AeoPageData = {
  slug: "locations/topeka-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Topeka industries served",
      body: [
        "Topeka's economy is unusually heavy in government, healthcare, and financial services — with strong manufacturing depth.",
      ],
      bullets: [
        "State government — agencies, departments, contractors, vendors, and the dense professional services class serving them",
        "Healthcare — Stormont Vail Health, the surrounding specialty practices, and clinics across Shawnee County",
        "Consumer products manufacturing — Hill's Pet Nutrition, Frito-Lay's Topeka plant, Goodyear's Topeka tire plant",
        "Financial services and banking — Capitol Federal Financial, regional banks, credit unions, and wealth management firms",
        "Utilities and energy — Evergy and the supplier network around Topeka power operations",
        "Higher education — Washburn University and Washburn Tech",
        "Professional services — law firms (especially government-adjacent), lobbying firms, accounting firms, and insurance brokerages",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Web Application Development — full-stack web applications for internal tools, vendor portals, agency-facing systems, and complex business logic.",
        "Business Automation Systems — automate invoicing, document handling, scheduling, reporting, and back-office workflows.",
        "AI Agent Development — custom AI agents for customer service, document processing, research, and operational decision support.",
  ...
  ctaSubcopy:
    "Tyler will scope your Topeka project personally — free, no commitment, no offshore handoff. In-person meeting in Topeka on request.",
};
