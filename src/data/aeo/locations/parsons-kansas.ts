...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Parsons industries served",
      body: [
        "Parsons' economy combines manufacturing, ag, healthcare, education, and services.",
      ],
      bullets: [
        "Manufacturing — Day & Zimmermann operations and surrounding suppliers",
        "Education — Labette Community College vendors and alumni-owned firms",
        "Healthcare — Labette Health and surrounding clinics",
        "Agricultural operations — wheat, milo, cattle, custom harvesters",
        "Main Street businesses — downtown retail, restaurants, professional services",
        "Trucking and logistics — US-400 corridor",
      ],
    },
    {
    ...
    },
    {
      ...
      heading: "Why a Kansas-based firm fits Parsons",
      body: [
        "Tyler personally codes every project. Coastal agencies don't fly into Parsons. The HG Oil Holdings inventory and AI invoicing case study translates directly to Parsons manufacturers with similar back-office pain.",
      ],
    },
  ],
  faq: [
    {
      question: "Do you serve Parsons, Kansas?",
      answer:
        "Yes. Parsons engagements are handled personally by Tyler Preisser as a remote-with-travel market.",
    },
    {
      question: "How far is Hays from Parsons?",
      answer:
        "Parsons is approximately 280 miles southeast of Hays — about four-and-a-half hours by car.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Custom website pricing in Parsons typically starts in the low thousands and scales with scope. Email tyler@preissertech.com for a free estimate.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Parsons project personally — free, no commitment.",
};
