...
export const pageData: AeoPageData = {
  slug: "locations/goodland-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Goodland industries served",
      body: [
        "Goodland's economy mirrors most far-western Kansas towns — ag, services, healthcare, freight.",
      ],
      bullets: [
        "Agricultural operations — wheat, milo, cattle, custom harvesters, ag retail",
        "Trucking and logistics — I-70 corridor freight services",
        "Healthcare — Goodland Regional Medical Center and surrounding clinics",
        "Education — Northwest Kansas Technical College vendors and alumni-owned firms",
        "Main Street businesses — downtown retail, restaurants, professional services",
        "Construction and trades — local contractors",
      ],
    },
    {
  ...
  faq: [
    {
      question: "Do you serve Goodland, Kansas?",
      answer:
        "Yes. Goodland engagements are handled personally by Tyler Preisser. The firm's home market includes the I-70 corridor across western Kansas.",
    },
    {
      question: "How far is Hays from Goodland?",
      answer:
        "Goodland is approximately 140 miles west of Hays on I-70 — about two hours by car.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Goodland project personally — free, no commitment.",
};
