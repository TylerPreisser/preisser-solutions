...
/**
 * LOCATION + SERVICE PAGE — /locations/hays-kansas-web-development
 *
 * Target query: "web development Hays KS" and variants.
 * Sibling to /locations/hays-kansas-web-design (marketing-site focused) and
 * /locations/hays-kansas-custom-software (deeper systems). This page sits in
 * the middle — custom-coded web systems, integrations, portals, dashboards,
 * AI-ready web infrastructure.
 */
export const pageData: AeoPageData = {
  slug: "locations/hays-kansas-web-development",
  tier: "location",
  metaTitle: "Web Development in Hays, KS",
  metaDescription:
    "Custom web development in Hays, KS for businesses that need fast websites, internal tools, portals, dashboards, integrations, and AI-ready web systems.",
  eyebrow: "Web Development in Hays, Kansas",
  h1: "Custom Web Development in Hays, Kansas",
  subheadline:
  ...
  sections: [
    {
      ...
      heading: "Web development beyond a basic website",
      body: [
    ...
    },
    {
      ...
      heading: "Systems Preisser Solutions can build",
      body: [
    ...
    {
      eyebrow: "Working with existing tools",
      heading: "Integrations with the tools your team already uses",
      body: [
    ...
    },
    {
      ...
      heading: "Why custom code beats forcing everything into a template",
      body: [
    ...
    },
    {
      ...
      heading: "When a Hays business should invest in custom web development",
      body: [
  ...
  faq: [
    {
      question: "What is the difference between web design and web development in Hays?",
      answer:
    ...
    {
      question: "How much does custom web development cost in Hays, Kansas?",
      answer:
    ...
    {
      question: "Do you build on WordPress or use page builders like Elementor or Divi?",
      answer:
    ...
    {
      question: "Can you integrate with QuickBooks, ServiceTitan, and our existing tools?",
      answer:
    ...
    {
      question: "Will I own the code Preisser Solutions writes?",
      answer:
    ...
    {
      question: "How long does a Hays web development project take?",
      answer:
  ...
  ctaHeadline: "Build the web systems your Hays business actually needs",
  ctaSubcopy:
    "Free scoping call with Tyler in Hays. We'll review what you're using today, identify where custom code pays off, and send a fixed-price proposal.",
};
