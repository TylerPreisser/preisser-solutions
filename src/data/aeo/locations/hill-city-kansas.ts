...
export const pageData: AeoPageData = {
  slug: "locations/hill-city-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Hill City industries served",
      body: [
        "Hill City's economy combines ag, oilfield, and small-town services.",
      ],
      bullets: [
        "Agricultural operations — wheat, milo, cattle, custom harvesters, ag retail",
        "Oilfield services — operators and service firms across Graham County",
        "Healthcare — Graham County Hospital and surrounding clinics",
        "Main Street businesses — downtown retail, restaurants, professional services",
        "Trucking and ag transport — US-283 and US-24 corridors",
  ...
  faq: [
    {
      question: "Do you serve Hill City, Kansas?",
      answer:
        "Yes. Hill City engagements are handled personally by Tyler Preisser, with in-person scoping calls and milestone meetings standard. Hill City sits about 50 miles north of Hays on US-283.",
    },
    {
      question: "How far is Hays from Hill City?",
      answer:
        "Hill City is about 50 miles north of Hays via US-283 — roughly an hour by car.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Custom website pricing in Hill City typically starts in the low thousands and scales with scope. Email tyler@preissertech.com for a free estimate.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Hill City project personally — free, no commitment.",
};
