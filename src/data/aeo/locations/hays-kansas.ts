...
/**
 * LOCATION PAGE — /locations/hays-kansas
 * Home market. Highest priority. HQ city.
 */
export const pageData: AeoPageData = {
  slug: "locations/hays-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Industries served across Hays and Ellis County",
      body: [
        "The Hays economy is anchored by Fort Hays State University, HaysMed (the regional medical center), and a deep oil and gas services sector across Ellis County. Layered on top is a robust ag economy, a meaningful retail and hospitality corridor, and a growing professional services class.",
      ],
      bullets: [
        "Fort Hays State University ecosystem — vendor relationships, university-adjacent businesses, student-housing operators, and FHSU alumni-owned firms",
        "HaysMed and affiliated medical practices — clinics, specialty groups, dental offices, and healthcare adjacent operators that need HIPAA-aware tooling",
        "Oilfield services across Ellis County — operators, service rigs, water haulers, and supply yards that need inventory, dispatch, and back-office automation",
        "Agricultural operations — feedlots, custom harvesters, equipment dealers, ag retail, and family farms",
        "Hospitality and retail — Vine Street and 27th Street corridor businesses, hotels along I-70, and Main Street operators",
        "Professional services — law firms, accounting firms, insurance agencies, and financial advisors serving western Kansas",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Web Application Development — full-stack web applications for internal tools, client portals, scheduling systems, and complex business logic specific to your operation.",
        "Business Automation Systems — automate invoicing, scheduling, data entry, reporting, and back-office workflows using AI and custom software.",
        "AI Agent Development — custom AI agents trained on your business that handle customer service, research, and decision support.",
        "Dashboards & Analytics — real-time business dashboards that surface live KPIs to owners, operators, and field crews.",
      ],
    },
    {
      ...
      subsections: [
        {
          ...
          body: [
            "Built a hands-free AI marketing engine plus a fully automated SMS/email reactivation system tied to their CRM. Result: 5x organic reach increase in 30 days, 60%+ reactivation of dormant patients within 6 weeks, 10+ hours per week saved, and replaced the need for outsourced marketing staff.",
          ],
        },
        {
          heading: "HG Oil Holdings — inventory management and AI invoicing",
          body: [
            "Custom inventory system tracking materials, transfers, live counts, and built-in markup formulas — plus a custom AI invoice assistant that extracts and structures invoice data instantly. Result: 95% reduction in back-office logistics time, 75%+ accuracy improvement, eliminated manual invoice reading, and prevented the need for additional hires.",
          ],
        },
      ],
    },
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
 "Most Hays engagements move from first call to signed proposal in under a week, with build kickoff shortly after. Because Tyler is local, the scoping call happens in person and on your schedule. Email tyler@preissersolutions.com. to schedule.",
    },
    {
  ...
  relatedLinks: [
    ...
    { label: "Hays, KS web applications", href: "/locations/hays-kansas-web-applications" },
    { label: "Hays, KS custom software", href: "/locations/hays-kansas-custom-software" },
  ...
  ctaHeadline: "Build with the only premium custom-software firm in Hays",
  ctaSubcopy:
    "Tyler will scope your project personally — free, no commitment, no sales pitch. Coffee in town or a call, your choice.",
};
