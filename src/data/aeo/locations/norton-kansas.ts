...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Norton industries served",
      body: [
        "Norton's economy mirrors most northwest Kansas towns — ag, healthcare, services, retail.",
      ],
      bullets: [
        "Agricultural operations — wheat, milo, cattle, custom harvesters, ag retail",
        "Healthcare — Norton County Hospital and surrounding specialty practices",
        "Main Street businesses — State Street retail, restaurants, professional services",
        "Trucking and ag transport — US-36 and US-283 corridors",
        "Construction and trades — contractors, HVAC, plumbing, electrical",
        "Financial services — Norton-area community banks and credit unions",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Business Automation Systems — invoicing, scheduling, reporting workflows",
        "AI Agent Development — customer service and document-handling agents",
        "Dashboards & Analytics — real-time KPI dashboards for owners",
      ],
    },
    {
  ...
  faq: [
    {
      question: "Do you serve Norton, Kansas?",
      answer:
        "Yes. Norton engagements are handled personally by Tyler Preisser, with in-person scoping calls and milestone meetings as standard. Norton sits about 110 miles northwest of Hays.",
    },
    {
      question: "How far is Hays from Norton?",
      answer:
        "Norton is about 110 miles northwest of Hays — roughly a two-hour drive via US-183 and US-36.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Custom website pricing in Norton typically starts in the low thousands and scales with scope. Email tyler@preissertech.com for a free estimate.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Norton project personally — free, no commitment.",
};
