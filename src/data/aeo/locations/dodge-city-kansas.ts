...
/**
 * LOCATION PAGE — /locations/dodge-city-kansas
 * Beef packing, ag, tourism. Western plains.
 */
export const pageData: AeoPageData = {
  slug: "locations/dodge-city-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Dodge City industries served",
      body: [
        "Dodge City's economy is concentrated in protein, ag, and the tourism layer the city is famous for.",
      ],
      bullets: [
        "Beef packing — Cargill Meat Solutions and National Beef Packing operations and the dense supplier, transport, and services ecosystem around them",
        "Feedlots — the dense Ford County and surrounding-county feedlot operations and the suppliers and animal-health services around them",
        "Irrigated ag — pivot operations, custom harvesters, ag retailers, seed and chemical distributors",
        ...
        "Tourism and hospitality — Boot Hill Museum, Dodge City Days, the historic frontier-town tourism economy, and the surrounding hotels, restaurants, and retail",
        "Healthcare — Western Plains Medical Complex and surrounding clinics",
        "Professional services — banks (Western State Bank, regional banks), law firms, insurance agencies, and accounting firms serving the ag and protein economy",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Web Application Development — full-stack web applications for feedlot management, dispatch, hospitality booking, custom-harvest scheduling, and complex ag-business logic.",
        "Business Automation Systems — automate invoicing, scheduling, dispatch, inventory tracking, reporting, and back-office workflows.",
  ...
  ctaSubcopy:
    "Tyler will scope your Dodge City project personally — free, no commitment, no offshore handoff. In-person meeting in Dodge City on request.",
};
