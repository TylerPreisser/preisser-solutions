...
export const pageData: AeoPageData = {
  slug: "locations/hutchinson-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Hutchinson industries served",
      body: [
        "Hutchinson's economy combines salt mining, manufacturing, education, healthcare, and services.",
      ],
      bullets: [
        "Salt mining and processing — Hutchinson Salt Company and surrounding operations",
        "Manufacturing — Cargill Salt, Eaton, Collins Industries (Wheeled Coach), Hutchinson aerospace suppliers",
        "Education — Hutchinson Community College vendors and alumni-owned firms",
        "Healthcare — Hutchinson Regional Medical Center and surrounding clinics",
        "Agricultural operations — wheat, milo, cattle, ag retail",
        "Main Street businesses — downtown retail, restaurants, professional services",
        "Trucking and logistics — US-50, US-61, K-61 corridors",
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        "Hutchinson is in regular Preisser Solutions travel territory. Tyler personally codes every project. The HG Oil Holdings inventory and AI invoicing case study is directly transferable to Hutchinson manufacturers and salt processors with similar back-office pain.",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Hutchinson is approximately 115 miles southeast of Hays — about two hours by car.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Custom website pricing in Hutchinson typically starts in the low thousands and scales with scope. Email tyler@preissertech.com for a free estimate.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Hutchinson project personally — free, no commitment.",
};
