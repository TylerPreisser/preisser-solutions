...
export const pageData: AeoPageData = {
  slug: "locations/overland-park-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Overland Park industries served",
      body: [
        "Overland Park's economy is one of the most diverse in the region — telecom, engineering, entertainment, logistics, healthcare, and professional services.",
      ],
      bullets: [
        "Telecom and corporate operations — Sprint/T-Mobile and surrounding suppliers",
        "Engineering and consulting — Black & Veatch and tier-2 suppliers",
        "Entertainment — AMC Theatres corporate",
        "Logistics — YRC Worldwide and surrounding firms",
        "Healthcare — Overland Park Regional Medical Center, AdventHealth, Saint Luke's South",
        "Professional services — law firms, accounting firms, financial advisors, wealth managers, insurance brokerages",
        "Real estate and home services — high-income consumer market",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Dashboards & Analytics — real-time KPI dashboards for executives and operators",
      ],
    },
    {
  ...
  faq: [
    {
      question: "Do you serve Overland Park, Kansas?",
      answer:
        "Yes. Overland Park engagements are handled personally by Tyler Preisser as a remote-with-travel market.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Business automation is a core service. Law firms, accounting firms, financial advisors, and insurance brokerages regularly automate intake, scheduling, document handling, and client communication. The future documented service-business example reactivation engine and a future documented operations example AI invoicing system both translate to professional services workflows.",
    },
  ],
  schemaType: "Service",
  namedEntities: [
  ...
  ctaSubcopy:
    "Tyler will scope your Overland Park project personally — free, no commitment.",
};
