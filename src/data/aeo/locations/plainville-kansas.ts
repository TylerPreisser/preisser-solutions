...
/**
 * LOCATION PAGE — /locations/plainville-kansas
 * Rooks County, ~25 mi north of Hays. Oil/gas + ag.
 */
export const pageData: AeoPageData = {
  slug: "locations/plainville-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Plainville industries served",
      body: [
    ...
    },
    {
      ...
      heading: "Why a Hays-based firm fits Plainville",
      body: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Plainville is about 25 miles north of Hays on US-183 — roughly a 30-minute drive. Tyler treats Plainville as part of the firm's home market, not a remote engagement.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Plainville project personally — free, no commitment, in-person on request.",
};
