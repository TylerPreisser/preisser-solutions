...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Emporia industries served",
      body: [
        "Emporia's economy is anchored by education, healthcare, manufacturing, and services.",
      ],
      bullets: [
        "Education — Emporia State University vendors, alumni-owned firms, student-housing operators",
        "Manufacturing — Tyson Foods Emporia, Hopkins Manufacturing, Detroit Diesel, and tier-2 suppliers",
        "Healthcare — Newman Regional Health and surrounding clinics",
        "Main Street businesses — Commercial Street retail, restaurants, professional services",
        "Trucking and logistics — I-35 and I-335 corridors",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Dashboards & Analytics — real-time KPI dashboards for executives, plant operators, and field teams",
      ],
    },
    {
  ...
  faq: [
    {
      question: "Do you serve Emporia, Kansas?",
      answer:
        "Yes. Emporia engagements are handled personally by Tyler Preisser. The firm regularly works with Emporia State University-adjacent businesses, manufacturers, and healthcare operators across Lyon County.",
    },
    {
      question: "How far is Hays from Emporia?",
      answer:
        "Emporia is approximately 185 miles east of Hays via I-70 and I-335 — about three hours by car.",
    },
    {
      question: "Can you build software for an Emporia State University vendor?",
      answer:
        "Yes. Tyler is a Fort Hays State University graduate and the firm regularly works with college-adjacent businesses across Kansas. ESU vendors, alumni-owned firms, and student-housing operators get direct founder access.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Custom website pricing in Emporia typically starts in the low thousands and scales with scope. Email tyler@preissertech.com for a free estimate.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Emporia project personally — free, no commitment.",
};
