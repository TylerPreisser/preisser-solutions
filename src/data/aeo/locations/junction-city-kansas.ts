...
export const pageData: AeoPageData = {
  slug: "locations/junction-city-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Junction City industries served",
      body: [
        "Junction City's economy is anchored by Fort Riley-adjacent services, manufacturing, and Main Street commerce.",
      ],
      bullets: [
        "Fort Riley-adjacent services — housing operators, retail, restaurants, automotive, professional services",
        "Manufacturing — local tier-2 suppliers and light manufacturing",
        "Healthcare — Geary Community Hospital and surrounding clinics",
        "Main Street businesses — Washington Street retail, restaurants, professional services",
        "Trucking and logistics — I-70 and US-77 corridors",
  ...
  faq: [
    {
      question: "Do you serve Junction City, Kansas?",
      answer:
        "Yes. Junction City engagements are handled personally by Tyler Preisser, with in-person scoping calls and milestone meetings standard.",
    },
    {
      question: "How far is Hays from Junction City?",
      answer:
        "Junction City is approximately 165 miles east of Hays on I-70 — about two-and-a-half hours by car.",
    },
    {
      question: "Can you build software for a Fort Riley-adjacent business?",
      answer:
        "Yes. Preisser Solutions regularly builds for service operators, housing operators, retail, and professional services firms across Kansas. The Cassidy HVAC reactivation engine is directly transferable to high-turnover military-adjacent customer bases.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Custom website pricing in Junction City typically starts in the low thousands and scales with scope. Email tyler@preissertech.com for a free estimate.",
    },
    {
  ...
  ctaSubcopy:
    "Tyler will scope your Junction City project personally — free, no commitment.",
};
