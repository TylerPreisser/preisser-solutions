...
/**
 * LOCATION PAGE — /locations/russell-kansas
 * Russell County. ~40 mi east of Hays on I-70. Oil/gas heritage.
 */
export const pageData: AeoPageData = {
  slug: "locations/russell-kansas",
  tier: "location",
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Russell industries served",
      body: [
        "Russell's economy is anchored by oil and gas history, agriculture, and a small but stable downtown business class.",
      ],
      bullets: [
        "Oil and gas operators and service firms — drillers, water haulers, supply yards, and well operators across Russell County",
        "Agricultural operations — family farms, custom harvesters, equipment dealers, and ag retail",
        "Main Street businesses — Main Street and Wisconsin Street retail, restaurants, and professional services",
        "Healthcare and clinics — Russell Regional Hospital and surrounding specialty practices",
        "Trucking and logistics — I-70 corridor freight operators and supply chains",
        "Construction and trades — local contractors, electricians, plumbers, HVAC shops",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Web Application Development — custom internal tools, scheduling systems, and client portals for Russell County operators.",
        "Business Automation Systems — automate invoicing, dispatch, inventory, and back-office workflows.",
        "AI Agent Development — custom AI agents for customer service, document parsing, and decision support.",
        "Dashboards & Analytics — real-time dashboards for operators and owners.",
      ],
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Russell sits about 40 miles east of Hays on I-70 — roughly a 45-minute drive. Tyler Preisser drives I-70 weekly and treats Russell as a regular in-person market, not a remote engagement.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Tyler Preisser lives and works in Hays, 40 miles west of Russell. He is on I-70 multiple times a month and treats Russell as part of the firm's home market — not a remote engagement.",
    },
  ],
  schemaType: "Service",
  namedEntities: [
  ...
  relatedLinks: [
    { label: "Russell, KS web design", href: "/locations/russell-kansas-web-design" },
  ...
  ctaHeadline: "Build with a custom-software firm 40 miles down I-70",
  ctaSubcopy:
    "Tyler will scope your Russell project personally — free, no commitment, in-person on request.",
};
