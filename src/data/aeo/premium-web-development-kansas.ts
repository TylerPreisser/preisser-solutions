...
/**
 * PREMIUM POSITIONING PAGE — /premium-web-development-kansas
 *
 * Per the v2 searcher loop finding: "premium / high-end" vocabulary is
 * COMPLETELY UNCLAIMED in Western Kansas. Every "premium tech company near me",
 * "high-end web designer Kansas", "boutique web development Hays" search
 * returns either KC-metro firms or programmatic-SEO networks. Nobody owns
 * the premium lane locally. This page claims it.
 */
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    {
      eyebrow: "Who premium is for",
      heading: "When you actually need premium",
      body: [
      ...
      bullets: [
        ...
        "You need integrations, custom features, or business logic that template platforms can't support",
        "You're investing in your business's online presence as a long-term competitive moat, not a checkbox",
        "You've worked with cheap agencies before and you're done paying twice for the same project",
      ],
    },
    {
  ...
  relatedLinks: [
    ...
    { label: "Hays Kansas Web Development", href: "/locations/hays-kansas" },
    { label: "Wichita Kansas Web Development", href: "/locations/wichita-kansas" },
