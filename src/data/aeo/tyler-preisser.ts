...
/**
 * PERSONAL BRAND PAGE — /tyler-preisser
 *
 * Consolidates personal-brand searches:
 * - "Tyler Preisser"
 * - "Tyler Preisser Hays Kansas"
...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    {
      eyebrow: "Inventions",
      heading: "Six original inventions across agriculture, aerospace, energy, and consumer goods",
      body: [
    ...
    },
    {
      ...
      body: [
        ...
        "Tyler's industry background spans agriculture, aviation, oilfield services, and high-growth technology. That breadth means Preisser Solutions can walk into a Kansas business, understand the workflow within an hour, and ship a working automation system in weeks rather than quarters.",
      ],
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
 "Tyler Preisser is based in Hays, Kansas (Ellis County). He works with businesses across Kansas and selectively serves remote clients nationwide. Contact: tyler@preissersolutions.com.",
    },
    {
      question: "What companies has Tyler Preisser worked with?",
      answer:
        "Tyler's named client portfolio includes Cassidy HVAC (AI marketing automation, customer reactivation systems), HG Oil Holdings (inventory management, AI invoicing assistant), Iron and Oak Podcast (full media brand build), and Wife Supply Co (AI gifting platform).",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Tyler Preisser graduated from Fort Hays State University in 2025 with a Bachelor of Science in Engineering Design and Technology. He received the Hansen Hall scholarship and placed second in the Kansas Startup category of FHSU's Faulkner Challenge with the Sky Sprayers drone docking project. He remains based in Hays and primarily serves Kansas businesses through Preisser Solutions.",
    },
    {
      question: "How do I get in touch with Tyler Preisser?",
      answer:
 "Email tyler@preissersolutions.com. Tyler personally responds to all inquiries. You can also use the contact form on preissersolutions.com.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. While Tyler concentrates on Kansas businesses, he regularly takes on remote engagements nationwide. Most work is conducted via video calls and shared project management, with periodic in-person travel as needed.",
    },
    {
  ...
  namedEntities: [
    ...
    "Sky Sprayers",
    "Bia AgTech",
    "Electromagnetic Pulsation Motor",
