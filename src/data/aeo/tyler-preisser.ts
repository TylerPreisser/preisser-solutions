...
export const pageData: AeoPageData = {
  ...
  sections: [
    {
      eyebrow: "Background",
      heading: "Hays, Kansas roots — built across aviation, oil and gas, and tech",
      body: [
        "Tyler Preisser is a Hays, Kansas native and Fort Hays State University graduate. His professional background spans aviation services, oil and gas operations, and high-growth technology consulting — a breadth that gives him operational fluency with the realities of how Kansas businesses actually run.",
        "That cross-industry foundation is intentional. Most coastal agencies don't understand the workflows, vocabulary, or constraints of an HVAC owner-operator in Hays, an oil and gas controller in Russell, or a rural hospital administrator in Plainville. Tyler does — because he grew up around them.",
      ],
    },
    {
