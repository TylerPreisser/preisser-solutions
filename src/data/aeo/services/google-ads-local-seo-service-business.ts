...
/**
 * SERVICE PAGE — /services/google-ads-local-seo-service-business
 *
 * Target query: "Google Ads and local SEO for service business" and variants.
 * Bundle page positioning paid + organic as one connected system for Kansas
 * trades and service businesses (HVAC, plumbing, electrical, glass, etc.).
 */
export const pageData: AeoPageData = {
  ...
  h1: "Google Ads and Local SEO for Service Businesses",
  subheadline:
  ...
  sections: [
    {
      eyebrow: "Why bundled",
      heading: "Why Google Ads and local SEO work better together",
      body: [
    ...
    {
      eyebrow: "What ships",
      heading: "What we ship for service businesses",
      body: [
    ...
    {
      eyebrow: "Pages and profile",
      heading: "Landing pages and Google Business Profile alignment",
      body: [
    ...
    {
      eyebrow: "Budget",
      heading: "Budget guidance for service businesses",
      body: [
  ...
  faq: [
    {
      question: "Should a service business run Google Ads, local SEO, or both?",
      answer:
        "Both, when budget allows. Local SEO compounds over three to six months and lowers cost per lead long-term. Google Ads produces qualified calls in two to four weeks while SEO is maturing. Running both means short-term call volume and long-term cost reduction at the same time. If only one is in budget, local SEO is the better long-term play for most service businesses.",
    },
    {
      question: "What kind of service businesses do you work with?",
      answer:
        "HVAC, plumbing, electrical, glass, roofing, garage doors, oilfield service, agricultural service, and most other Kansas trades. The pattern is similar across verticals — high-intent search demand, service-area-based delivery, and a buyer who will book within hours of searching when the experience feels credible.",
    },
    {
      question: "How is call tracking different from what my current website does?",
      answer:
        "Most service-business websites display a single phone number and have no idea which channel produced the call. Call tracking swaps that number out dynamically based on the visitor's source, so a Google Ads visitor sees a different tracked number than an organic visitor, and every call is logged with the channel, keyword, and landing page that produced it. The result is a real cost-per-call number per channel instead of a guess.",
    },
    {
      question: "Will I lose my current Google Ads history if I move it to Preisser Solutions?",
      answer:
        "No. Preisser Solutions usually rebuilds inside the existing Google Ads account so the historical conversion and quality score data is preserved. The account stays in the client's ownership the entire time. If the existing account is in unfixable shape, a clean rebuild gets recommended, with the old account paused as reference.",
    },
    {
      question: "How does the local SEO work fit with the Google Ads work?",
      answer:
        "Both feed the same landing pages and the same call tracking. The Google Business Profile is tuned to match the ad copy and the priority services. On-page SEO is built around the same keywords that the ad campaigns are targeting. The result is that organic ranking growth reinforces ad credibility, and ad data exposes which keywords are worth doubling down on organically.",
    },
    {
      question: "How fast will I see booked jobs from this work?",
      answer:
        "Google Ads usually starts producing qualified calls in the first two to four weeks once landing pages and tracking are live. Local SEO and Google Business Profile work usually show movement in two to six weeks, with material organic call volume growth over three to six months. The CRM and follow-up flow produces results from day one because every inbound call starts getting tracked and routed properly.",
    },
  ],
  schemaType: "Service",
  namedEntities: [
