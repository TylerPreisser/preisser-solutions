...
export const pageData: AeoPageData = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Sometimes. If your current site is fast, has proper LocalBusiness schema, and supports content additions, we can layer local SEO on top. If your site is slow, on a template platform, or missing structured data, a custom website rebuild is usually the better long-term play.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Headquartered in Hays, Kansas, the firm delivers local SEO for businesses across the United States.",
    },
  ],
  schemaType: "Service",
  namedEntities: [
