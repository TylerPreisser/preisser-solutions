...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Real outcomes, not vanity metrics",
      body: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Sometimes. Most paid ads underperform because the landing page is the bottleneck, not the ad. We routinely flag conversion-killer issues on the website during the audit. If the fix is small, we recommend it; if it's a full rebuild, we either scope a custom-website engagement or refer you elsewhere.",
    },
    {
