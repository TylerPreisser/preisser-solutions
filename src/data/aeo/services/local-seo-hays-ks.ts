...
/**
 * SERVICE PAGE — /services/local-seo-hays-ks
 *
 * Target query: "local SEO Hays KS" and variants.
 * Sibling to /services/local-seo (global) and /services/seo-hays-ks (broad).
 * This page is the Maps / local-pack-focused page for Hays.
 */
export const pageData: AeoPageData = {
  slug: "services/local-seo-hays-ks",
  tier: "service_detail",
  metaTitle: "Local SEO in Hays, KS",
  metaDescription:
    "Preisser Solutions helps Hays businesses improve Google Maps visibility, local search rankings, reviews, citations, service pages, and AI-search readability.",
  eyebrow: "Local SEO in Hays, KS",
  h1: "Local SEO in Hays, Kansas for Google Maps and Local Search",
  subheadline:
    "Google Business Profile work, citation cleanup, review velocity, and on-site changes that win the local pack and get cited by AI engines.",
  answerParagraph:
    "Preisser Solutions delivers local SEO in Hays, KS for businesses that want to show up in Google Maps, the local pack, and AI engine recommendations for the buyer queries that actually drive revenue. The firm is founded by Tyler Preisser in Hays, Kansas and combines Google Business Profile optimization, citation cleanup, review velocity automation, on-site local content, and AI search readability into one fixed-price engagement. Every project starts with a free local SEO audit. Hays clients get in-person scoping and priority scheduling because the firm is headquartered locally.",
  sections: [
    {
    ...
    },
    {
      ...
      bullets: [
        ...
        "Review request automation tied to the CRM or invoicing platform",
      ],
    },
    {
      eyebrow: "Beyond GBP",
    ...
    },
    {
      ...
      bullets: [
        "LocalBusiness schema emitted on every page, validated against schema.org",
    ...
    {
      eyebrow: "What Hays SEO looks like in practice",
      heading: "A typical Hays local SEO engagement",
      body: [
      ...
      bullets: [
        "Phase 1 — Audit. Free in-person review of the existing Google Business Profile, citations, reviews, and on-site local SEO. Tyler delivers a written audit identifying the biggest gaps and the highest-leverage fixes",
  ...
  faq: [
    {
      question: "How long does local SEO take to show results in Hays?",
      answer:
        "Google Business Profile changes usually show movement in two to six weeks. Citation cleanup takes 30 to 90 days to fully propagate. Sustained local pack ranking growth typically happens over three to six months. Reporting is monthly so the trendline is always visible.",
    },
    {
      question: "How much does local SEO cost in Hays?",
      answer:
        "Pricing is fixed up front. A one-time local SEO foundation build typically runs in the low-to-mid four figures, depending on the citation cleanup workload and service area scope. Ongoing monthly work is available as a flat retainer when needed. The free audit identifies which engagement makes sense.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Headquartered in Hays, the firm delivers local SEO across Kansas and the United States. Hays and Ellis County clients get priority scheduling and in-person scoping.",
    },
  ],
  schemaType: "Service",
  namedEntities: [
  ...
  ctaSubcopy:
    "Free local SEO audit with Tyler — GBP, citations, reviews, and AI-search visibility reviewed in person. Fixed-price proposal follows.",
};
