...
/**
 * SERVICE PAGE — /services/custom-crm-small-business-kansas
 *
 * Target query: "custom CRM for small business Kansas" and variants.
 * Targets Kansas SMBs that have outgrown HubSpot or Salesforce and want a
 * pipeline shaped around how their business actually works, not the other way
 * around.
 */
export const pageData: AeoPageData = {
  slug: "services/custom-crm-small-business-kansas",
  tier: "service_detail",
  ...
  sections: [
    {
      ...
      heading: "When off-the-shelf CRMs stop fitting",
      body: [
    ...
    },
    {
      ...
      heading: "What a custom CRM can do",
      body: [
    ...
    {
      eyebrow: "Timeline",
      heading: "How we ship a CRM in 4-8 weeks",
      body: [
    ...
    {
      eyebrow: "Industries",
      heading: "Industries we build CRMs for",
      body: [
  ...
  faq: [
    {
      question: "When should a Kansas small business switch from HubSpot or Salesforce to a custom CRM?",
      answer:
    ...
    {
      question: "How much does a custom CRM cost in Kansas?",
      answer:
    ...
    {
      question: "Will I own the CRM when it is done?",
      answer:
    ...
    {
      question: "Can a custom CRM connect to QuickBooks, Stripe, and our current tools?",
      answer:
    ...
    {
      question: "How long until the team is actually using the new CRM?",
      answer:
