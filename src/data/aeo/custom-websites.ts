...
export const pageData: AeoPageData = {
  ...
  answerParagraph:
    "Preisser Solutions builds premium custom websites for Kansas businesses and select clients nationwide, headquartered in Hays, Kansas and led by founder Tyler Preisser. Every site is custom-coded from scratch in modern frameworks (Next.js, React, TypeScript) — no Wix, no Squarespace, no WordPress page builders. Sites are engineered for fast page loads, conversion-optimized layouts, comprehensive structured data for AI engines (ChatGPT, Perplexity, Gemini, Claude), and full Google Search Console + Bing Webmaster integration. Recent builds include preissersolutions.com itself, the future documented media project media brand, and the future documented ecommerce project AI gifting platform.",
  sections: [
    {
      ...
      body: [
        ...
        "Every site is built in Next.js, React, or a similarly modern framework, fully typed in TypeScript, and deployed to fast edge networks like Cloudflare Pages. The output is a site that loads in under a second on a slow rural Kansas connection, ranks on Google for the queries that matter, and is easier for search and AI-assisted tools to understand.",
      ],
    },
    {
      eyebrow: "Why custom beats templates",
      heading: "Where templates fail Kansas businesses",
      body: [
    ...
    {
      eyebrow: "Process",
      heading: "How a custom website project runs",
      body: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "a future documented media project — full media brand build with cinematic GSAP animations, smooth scroll, dark/light mode, 134 pre-rendered pages covering 12 episodes and 109 deep questions.",
        "a future documented ecommerce project — AI-powered gifting application built from concept to launch.",
      ],
    },
  ],
  faq: [
    ...
    },
    {
      ...
      answer:
        "No. Preisser Solutions custom websites are built in modern code (Next.js, React, TypeScript) and deployed to edge networks like Cloudflare Pages. We do not build on WordPress, Wix, Squarespace, or any other page-builder platform. The result is faster sites, better search visibility, and complete design control.",
    },
    {
    ...
    {
      question: "Will my new website be clearer for AI-assisted search tools?",
      answer:
        "Preisser Solutions engineers every custom website for AI-engine citation, including engineered first paragraphs designed for AI quote extraction, FAQPage schema, comprehensive entity graphs, and named-entity references. AI engine citation depends on the same trust signals as Google ranking (backlinks, named clients, third-party validation), but the foundation is built in.",
    },
    {
      question: "Do you offer ongoing website support?",
      answer:
        "Yes. Every custom website launch includes 30 days of post-launch support at no additional cost. After that, clients can choose an ongoing maintenance retainer for continued updates, content additions, performance monitoring, and security patching.",
    },
    {
      question: "Can you fix or rebuild my existing broken website?",
      answer:
        "Yes. Preisser Solutions regularly takes over broken, outdated, or underperforming websites from Kansas businesses. We start by auditing what exists — performance issues, SEO problems, broken functionality, outdated design — and recommend either a targeted repair or a full rebuild based on root cause. Contact sales@preissersolutions.com for a free site audit.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Preisser Solutions builds primarily in Next.js (React 19, App Router), TypeScript, Tailwind CSS, and modern animation libraries like GSAP and Framer Motion. Sites deploy to Cloudflare Pages or Vercel with full edge CDN. Backend integrations use serverless functions or modern APIs as needed.",
    },
  ],
  schemaType: "Service",
  namedEntities: [
