...
/**
 * INSIGHT ARTICLE — /insights/get-more-local-customers-from-google
 *
 * Comprehensive local SEO playbook for small businesses.
 */
export const pageData: AeoPageData = {
  slug: "insights/get-more-local-customers-from-google",
  tier: "blog",
  ...
  h1: "How to Get More Local Customers from Google",
  subheadline:
  ...
  sections: [
    ...
    {
      eyebrow: "Step 2",
      heading: "Build pages for services people search",
      body: [
    ...
    {
      eyebrow: "Step 4",
      heading: "Earn and respond to reviews",
      body: [
    ...
    {
      eyebrow: "Step 6",
      heading: "Add AI search readability",
      body: [
  ...
  faq: [
    {
      question: "How much does local SEO cost for a small business?",
      answer:
        "For a typical local service business in a town like Hays, a focused local SEO engagement runs in the low-to-mid four figures monthly, with a larger initial setup investment. DIY is genuinely possible if the owner is technical and willing to spend several hours a week. The right question is rarely cost — it is which leads you're already missing while you decide.",
    },
    {
      question: "How long does local SEO take to work?",
      answer:
        "First measurable gains usually appear within 30 to 60 days — more profile views, more direction requests, more form starts. Map pack ranking shifts often take 60 to 120 days. Compounding gains in lead volume become clear at 6 to 9 months. The work doesn't stop after launch; it's a steady quarterly cadence.",
    },
    {
      question: "Do I need separate websites for each town I serve?",
      answer:
        "Not separate websites. Separate location pages on the same website. One page per primary town, written specifically for that town, with the service area listed and unique local details (photos, projects, customer references). A single site with strong location pages outperforms multiple thin sites and is far simpler to maintain.",
    },
    {
      question: "What's more important: Google Ads or local SEO?",
      answer:
        "They solve different problems. Ads buy immediate visibility while you're building the organic foundation. Local SEO compounds over time and produces leads at a lower per-lead cost once it's established. Most small businesses are well served by running both — modest ads for the high-intent commercial terms while SEO catches up over 6 to 12 months.",
    },
    {
      question: "Can I do this myself or should I hire someone?",
      answer:
        "A technical owner with a few hours a week can run most of this. The pieces that benefit most from outside help: technical SEO on the website, schema markup, content writing for service pages, and the discipline to keep the review and posting cadence going every week. Many owners DIY the profile and reviews and hire help for the website layer.",
    },
    {
      question: "Does AI search optimization conflict with traditional SEO?",
      answer:
        "No, they reinforce each other. The same things that make a page easy for ChatGPT or Perplexity to read — clear structure, named entities, concrete answers, schema markup, fast loading — also help Google rank the page. The work overlaps roughly 80%. Doing one well is most of the work for doing the other.",
    },
  ],
  schemaType: "Article",
  namedEntities: [
