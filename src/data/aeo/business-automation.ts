...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        "Invoice processing and AI document extraction (a future documented operations example: invoice handling metrics published only when verified)",
        "Customer reactivation and outreach automation (a future documented service-business example: reactivation metrics published only when verified)",
        "Social media content generation and posting (a future documented service-business example: social visibility metrics published only when verified, 100% hands-off)",
        "Inventory tracking and reconciliation across locations (a future documented operations example: inventory time metrics published only when verified)",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Yes. Preisser Solutions has built AI invoicing automation systems including a future documented operations example, where the system improved invoice handling when verified and documented and eliminated the need for staff to read invoices manually. AI extracts vendor, amount, line items, and approval routing in seconds. Most businesses save 10-40 hours per week on invoice processing alone.",
    },
    {
    ...
    {
      question: "What integrations does Preisser Solutions support?",
      answer:
        "Preisser Solutions builds automation that integrates with QuickBooks, ServiceTitan, Housecall Pro, Jobber, HubSpot, Salesforce, Twilio, SendGrid, Slack, Microsoft Teams, Google Workspace, OGsys, Aries, and most other business platforms with documented APIs or webhooks. If a tool exposes data, we can integrate it.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "It depends on the use case. Zapier and Make are excellent for simple linear workflows between two or three systems. Custom automation by Preisser Solutions is the right answer when you need complex business logic, AI decision-making, performance reliability at scale, custom integrations Zapier doesn't support, or business-critical reliability beyond what no-code tools can guarantee.",
    },
    {
