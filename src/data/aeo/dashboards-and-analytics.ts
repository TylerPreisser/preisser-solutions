...
export const pageData: AeoPageData = {
  ...
  tier: "service_detail",
  metaTitle: "Custom Business Dashboards in Kansas",
  metaDescription:
  ...
  sections: [
    ...
    {
      eyebrow: "Common dashboard types",
    ...
    {
      eyebrow: "How dashboards integrate",
      heading: "Pulls live data from your existing tools",
      body: [
        "Most dashboards combine data from 3-8 different business systems. Common integrations:",
      ],
      bullets: [
        ...
        "Marketing: Google Analytics, Google Ads, Facebook Ads, HubSpot Marketing",
        "Industry-specific: OGsys, Aries, Epic, Athena",
        "Custom databases (Postgres, MySQL, SQL Server, Airtable)",
        "Direct file imports (CSV, Excel, Google Sheets) when systems lack APIs",
      ],
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Most custom dashboards launch within 4-8 weeks. Single-system dashboards deliver in 3-4 weeks. Multi-system dashboards with complex calculations or industry-specific logic run 6-8 weeks.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Preisser Solutions has built operational dashboards for oil and gas (HG Oil Holdings inventory tracking) and is regularly engaged for industry-specific dashboards in healthcare, manufacturing, home services, and ag. Industry-specific data sources (OGsys, Epic, Athena) integrate the same way as general business tools.",
    },
  ],
  schemaType: "Service",
  namedEntities: [
