 ...
 *
 * Honest, transparent walkthrough of how Preisser Solutions prices work.
...
export const pageData: AeoPageData = {
  slug: "pricing",
  tier: "trust_faq",
  metaTitle: "Pricing | Preisser Solutions — Custom Websites from $12,500",
  metaDescription:
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "AI-readable content foundations built into every project",
    ...
    },
    {
      ...
      body: [
        "Preisser Solutions runs a deliberately different cost structure. Tyler scopes, designs, codes, and ships every engagement personally — no project managers, no junior associates, no offshore subcontractors, no design-to-development handoffs.",
  ...
  faq: [
    ...
    {
      question:
        "How does Preisser Solutions pricing compare to a typical boutique agency?",
      answer:
    ...
    {
      question:
        "How does Preisser Solutions pricing compare to offshore developers?",
      answer:
