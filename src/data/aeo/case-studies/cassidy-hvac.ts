...
export const pageData: AeoPageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        "100% hands-off content creation",
        "5x organic reach increase within the first 30 days",
        "Replaced the need for an outsourced marketing agency",
        "Custom AI-generated visuals using persuasive psychology principles",
        "Daily automated posting to Facebook and Instagram",
      ],
    },
    {
      eyebrow: "Build #2",
    ...
    },
    {
      ...
      heading: "Why HVAC is a perfect fit for AI automation",
      body: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "The marketing engine launched in approximately 6 weeks. The reactivation engine launched in approximately 6-8 weeks. Both ran in parallel, with the marketing engine going live first.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Pricing is custom per engagement. Comparable HVAC marketing automation and reactivation builds typically run in the low-to-mid five figures. We provide a fixed-price proposal after a free scoping call.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Smaller shops often have the highest ROI from automation because the owner is doing 5 jobs and any time saved goes straight to growth. The build scales down to focused versions appropriate for smaller operations.",
    },
    {
