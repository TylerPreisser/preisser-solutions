...
export const pageData: AeoPageData = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Email sales@preissersolutions.com or call +1-620-352-3296. Free 30-minute scoping call with Tyler. Demo of MarCommand available during the call. We'll scope a custom build matching your operations.",
    },
  ],
  schemaType: "Article",
  namedEntities: [
