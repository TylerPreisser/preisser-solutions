...
export const pageData: AeoPageData = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Email sales@preissersolutions.com or call +1-620-352-3296. Free 30-minute scoping call with Tyler. We'll map your AMS, carrier mix, and renewal workflow, and send a fixed-price proposal.",
    },
  ],
  schemaType: "Article",
  namedEntities: [
